...
const initialRules: PermissionRule[] = [
  {
    ...
    onlyIfCreator: false,
    permissions: {
      select: false, read: true, write: false, create: false, delete: false,
      print: false, email: false, report: false, import: false, export: false, share: false,
    },
  },
  {
    id: "2",
    ...
    onlyIfCreator: false,
    permissions: {
      select: false, read: true, write: true, create: true, delete: true,
      print: true, email: true, report: true, import: false, export: true, share: true,
    },
  },
  {
    id: "3",
    ...
    onlyIfCreator: false,
    permissions: {
      select: true, read: true, write: true, create: true, delete: false,
      print: true, email: true, report: true, import: true, export: true, share: false,
    },
  },
  {
    id: "4",
  ...
  },
  {
    ...
    onlyIfCreator: true,
    permissions: {
      select: false, read: true, write: true, create: true, delete: false,
      print: false, email: false, report: false, import: false, export: false, share: false,
    },
  },
  {
    ...
    onlyIfCreator: false,
    permissions: {
      select: true, read: true, write: false, create: false, delete: false,
      print: true, email: true, report: true, import: false, export: true, share: true,
    },
  },
  {
  ...
  },
  {
    ...
    onlyIfCreator: false,
    permissions: {
      select: false, read: true, write: true, create: false, delete: false,
      print: false, email: false, report: true, import: false, export: false, share: false,
    },
  },
  {
    id: "11",
